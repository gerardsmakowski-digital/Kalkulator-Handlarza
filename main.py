...
# --- CSS (Stylizacja Montserrat + Naprawa ikony sidebaru) ---
st.markdown("""
    <style>
    @import url('https://fonts.googleapis.com/css2?family=Montserrat:wght@400;700&display=swap');
    * { font-family: 'Montserrat', sans-serif !important; }
    
    /* Ukrywamy standardowe elementy nagłówka */
    header { visibility: visible !important; background: rgba(0,0,0,0) !important; }
    footer { visibility: hidden !important; }
    #MainMenu { visibility: hidden !important; }

    /* --- NAPRAWA PRZYCISKU SIDEBARU --- */
    /* Ukrywamy napis 'keyboard_double_arrow' */
    ...
    /* Wyświetlamy ikonę (SVG) i kolorujemy ją na CZARNO po zwinięciu */
    ...
    /* Kolor strzałki na BIAŁO, gdy sidebar jest OTWARTY */
