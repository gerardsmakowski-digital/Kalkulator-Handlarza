...
st.markdown(f"<p style='text-align: center; color: #000; margin-bottom: 30px; margin-top:-20px; font-size: 18px;'>by Gerard S Digital Agency</p>", unsafe_allow_html=True)
